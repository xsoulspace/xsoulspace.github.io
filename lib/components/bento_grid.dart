  ...
  Iterable<Component> build(final BuildContext context) sync* {
    yield section(
      ...
      [
        ...
        div(
          ...
          [
            ...
            const ProjectCard(
              ...
              description:
                  'A groundbreaking application that showcases ethical AI integration',
              type: 'app',
              isLarge: true,
            ...
            const ProjectCard(
              title: 'Game Engine',
              description:
                  'Open-source 2D game engine built with performance in mind',
              type: 'game',
            ...
            const ProjectCard(
              ...
              description:
                  'Comprehensive Flutter UI components for rapid development',
              type: 'library',
            ...
            const ProjectCard(
              ...
              description:
                  'Interactive charts and graphs for complex data storytelling',
              type: 'app',
              contributors: ['Data Team', 'UX Team'],
            ),

            // Contributor Spotlight - Tall Card
            div(
              classes: 'contributor-spotlight',
              [
                h3(
                  classes: 'contributor-title',
                  [text('Contributor Spotlight')],
                ),
                div(
                  classes: 'contributor-profile',
                  [
                    div(
                      classes: 'contributor-avatar',
                      [
                        text('👤'),
                      ],
                    ),
                    ...
                    p(
                      classes: 'contributor-bio',
                      [
                        text(
                          'Full-stack developer passionate about ethical technology and sustainable software practices.',
                        ),
                      ],
                    ),
                    div(
                      classes: 'contributor-stats',
                      [text('15 contributions • 3 projects')],
                    ),
                  ],
                ),
              ],
            ...
            const ProjectCard(
              ...
              description:
                  'Secure, privacy-first authentication for modern apps',
              type: 'library',
            ...
            const ProjectCard(
              ...
              description:
                  'Customizable portfolio templates for creative professionals',
              type: 'app',
              contributors: ['Design Community'],
            ),
          ],
        ),
        ...
        div(
          classes: 'ethical-principles',
          [
            h2(
              classes: 'principles-title',
              [text('Our Ethical Foundation')],
            ),
            div(
              classes: 'principles-grid',
              [
                div(
                  classes: 'principle-card',
                  [
                    h3(
                      classes: 'principle-title',
                      [text('🌱 Sustainability')],
                    ),
                    p(
                      classes: 'principle-description',
                      [
                        text(
