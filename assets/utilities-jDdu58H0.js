const e=`- id: flutter_cli_ui
  ...
  media:
    type: image
    url: /src/assets/project_images/flutter_cli_ui/upgrading_packages.gif
  links: []
- id: tables_syncer
  title: Tables Syncer
  ...
  media:
    type: video
    url: https://youtu.be/c2MxCG5p6L0?si=tgW7o2bjSjFDqm6a
  links: []
- id: sheets_manager
  ...
  media:
    type: video
    url: https://youtu.be/hjaa2tn-big?si=HeHiaNOzO6sL2JXM
  links: []
`;export{e as default};
